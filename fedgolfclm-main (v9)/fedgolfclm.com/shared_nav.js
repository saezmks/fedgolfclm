...
(function () {
  ...
  const SITE_INDEX = [
    ...
    { titulo: 'Calendario e Inscripciones', url: 'inscripcion.html', desc: 'Calendario de torneos e inscripciones online', tags: 'torneos calendario inscripciones competiciones app' },
